          ...
          <div className="">
            <form action="">
              <div className="space-y-5 px-10 pt-8 pb-11">
                ...
                <div className="flex items-center border-[1px] rounded-[10px] border-[#e5e5e5] py-4 px-5 space-x-2">
                  <UserIcon />
                  <input
                ...
                <div className="flex items-center border-[1px] rounded-[10px] border-[#e5e5e5] py-4 px-5 ">
                  <PasswordIcon />
                  <input
                    className="w-full	placeholder placeholder:font-bold placeholder:text-[#000] pl-4 outline-none"
                    type="password"
                ...
                <div className="flex  gap-x-4">
                  <Button colorKey="pink" otherStyle="text-[#fff] font-bold">
                    Оформить
                  </Button>
                  <div className="text-left">
                    <a
                      href="#"
                      className="text-[#9f9f9f] text-xs leading-3 block"
                    >
                      Заблыли пароль?
                    </a>
                    <a
